...
const fr = {
  ...
  "config.existingClients": "Clients déjà configurés : {labels}",
  ...
  "config.targetFor": "Jours par semaine pour {label} (5 = temps plein) :",
...
const en: Record<keyof typeof fr, string> = {
  ...
  "config.existingClients": "Already configured: {labels}",
  ...
  "config.targetFor": "Days per week for {label} (5 = full-time):",
